...
ol.proj.get("EPSG:32749").setExtent([413766.003497, 9143256.619856, 442865.975300, 9158600.555166]);
var wms_layers = [];
...
var format_Perkecamatan_1 = new ol.format.GeoJSON();
var features_Perkecamatan_1 = format_Perkecamatan_1.readFeatures(json_Perkecamatan_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:32749'});
var jsonSource_Perkecamatan_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Perkecamatan_1.addFeatures(features_Perkecamatan_1);
var lyr_Perkecamatan_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Perkecamatan_1, 
                style: style_Perkecamatan_1,
                interactive: true,
                title: '<img src="styles/legend/Perkecamatan_1.png" /> Perkecamatan'
            });
...
lyr_Googleearth_0.setVisible(true);lyr_Perkecamatan_1.setVisible(true);lyr_overlay_krb_2.setVisible(true);lyr_BATAS_KEC_3.setVisible(true);
var layersList = [lyr_Googleearth_0,lyr_Perkecamatan_1,lyr_overlay_krb_2,lyr_BATAS_KEC_3];
lyr_Perkecamatan_1.set('fieldAliases', {'WADMKC': 'WADMKC', });
...
lyr_Perkecamatan_1.set('fieldImages', {'WADMKC': 'TextEdit', });
...
lyr_Perkecamatan_1.set('fieldLabels', {'WADMKC': 'inline label', });
